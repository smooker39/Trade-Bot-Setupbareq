...
import { TelegramSettings as TelegramSettingsComponent } from "@/components/TelegramSettings";
import { memoryCommander } from "@/lib/memoryCommander";

export const Telegram_EME = memo(() => {
  ...
  return (
    <div className="p-4 w-full box-border" style={{ contain: 'layout style', isolation: 'isolate' }}>
      <div className="flex justify-between items-center mb-2">
        <h3 className="text-sm font-bold">TELEGRAM EME</h3>
